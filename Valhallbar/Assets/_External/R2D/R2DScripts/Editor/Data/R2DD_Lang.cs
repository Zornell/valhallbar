...
namespace R2D {
	...
	public static class R2DD_Lang {
		public const string menuAccess 					= "Window/Ruler 2D/Open %#r";
		public const string toggleGuides				= "Window/Ruler 2D/Toggle Guides %#h";
		public const string toggleGrid					= "Window/Ruler 2D/Toggle Grid %#g";
